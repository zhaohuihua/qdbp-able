 ...
 * @since 5.1.1
 */
public class StartsFileMatcher extends BaseFileMatcher {
     ...
     */
    public StartsFileMatcher(String pattern, Target target) {
     ...
     */
    public StartsFileMatcher(String pattern, Target target, Matches mode) {
