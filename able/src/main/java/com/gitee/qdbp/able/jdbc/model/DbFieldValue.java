 ...
 * 先定义一个转换类: XxxToDbValueConverter implements Converter&lt;XxxEntity, DbFieldValue&gr;<br>
 * 再注入spring的ConversionService之中, ConfigableDataConvertHandler会判断XxxEntity能否转换为DbFieldValue
 *
 * @author zhaohuihua
 * @version 200123
 */
