 ...
 * @since 5.1.1
 */
public class EndsStringMatcher implements StringMatcher {
     ...
     * @param pattern 匹配规则
     */
    public EndsStringMatcher(String pattern) {
     ...
     */
    public EndsStringMatcher(String pattern, Matches mode) {
    ...
    public boolean matches(String source) {
        return source.endsWith(pattern) != reverse;
    }
