...
public class DbWhere extends DbItems {
    ...
    public DbWhere on(String fieldName, String operate, Object... fieldValues) {
        if (isMatches(operate, "IsNull", "is null", "IsNotNull", "is not null")) {
            ...
            if (VerifyTools.isBlank(arrayValues)) {
                String msg = "FieldValues is required, fieldName=%s, operate=%s";
                throw new IllegalArgumentException(String.format(msg, fieldName, operate));
            }
            if (arrayValues.size() < 2) {
                String msg = "FieldValues.size() can't be less then 2, fieldName=%s, operate=%s";
                throw new IllegalArgumentException(String.format(msg, fieldName, operate));
            }
            ...
            if (VerifyTools.isBlank(first)) {
                String msg = "FieldValue is required, fieldName=%s, operate=%s";
                throw new IllegalArgumentException(String.format(msg, fieldName, operate));
            }
            if (isMatches(operate, ">", "GreaterThen", "greater then")) {
                ...
                String msg = "Unsupported operate, fieldName=%s, operate=%s, fieldValue=%s";
    ...
    private DbWhere onEquals(String fieldName, Object fieldValue) {
        this.put("Equals", fieldName, fieldValue);
        return this;
    }

    /** WHERE :fieldName != :fieldValue **/
    private DbWhere onNotEquals(String fieldName, Object fieldValue) {
        this.put("NotEquals", fieldName, fieldValue);
        return this;
    }

    /** WHERE :fieldName &gt; :fieldValue **/
    private DbWhere onGreaterThen(String fieldName, Object fieldValue) {
        this.put("GreaterThen", fieldName, fieldValue);
        return this;
    }

    /** WHERE :fieldName &lt; :fieldValue **/
    private DbWhere onLessThen(String fieldName, Object fieldValue) {
        this.put("LessThen", fieldName, fieldValue);
        return this;
    }

    /** WHERE :fieldName &gt;= :fieldValue **/
    private DbWhere onGreaterEqualsThen(String fieldName, Object fieldValue) {
        this.put("GreaterEqualsThen", fieldName, fieldValue);
        return this;
    }

    /** WHERE :fieldName &lt;= :fieldValue **/
    private DbWhere onLessEqualsThen(String fieldName, Object fieldValue) {
        this.put("LessEqualsThen", fieldName, fieldValue);
        return this;
    }

    /** WHERE :fieldName IS NULL **/
    private DbWhere onIsNull(String fieldName) {
        this.put("IsNull", fieldName, null);
        return this;
    }

    /** WHERE :fieldName IS NOT NULL **/
    private DbWhere onIsNotNull(String fieldName) {
        this.put("IsNotNull", fieldName, null);
        return this;
    }

    /** WHERE :fieldName LIKE CONCAT('%', :fieldValue, '%') **/
    private DbWhere onLike(String fieldName, Object fieldValue) {
        this.put("Like", fieldName, fieldValue);
        return this;
    }

    /** WHERE :fieldName NOT LIKE CONCAT('%', :fieldValue, '%') **/
    private DbWhere onNotLike(String fieldName, Object fieldValue) {
        this.put("NotLike", fieldName, fieldValue);
        return this;
    }

    /** WHERE :fieldName LIKE CONCAT(:fieldValue, '%') **/
    private DbWhere onStarts(String fieldName, Object fieldValue) {
        this.put("Starts", fieldName, fieldValue);
        return this;
    }

    /** WHERE :fieldName LIKE CONCAT('%', :fieldValue) **/
    private DbWhere onEnds(String fieldName, Object fieldValue) {
        this.put("Ends", fieldName, fieldValue);
        return this;
    }

    // /** WHERE :fieldName NOT IN (:fieldValue1, :fieldValue2, ...) **/
    // private DbWhere onNotIn(String fieldName, Object... fieldValues) {
    //     this.put("NotIn", fieldName, fieldValues);
    //     return this;
    // }

    /** WHERE :fieldName IN (:fieldValue1, :fieldValue2, ...) **/
    private DbWhere onNotIn(String fieldName, List<?> fieldValues) {
        this.put("NotIn", fieldName, fieldValues);
        return this;
    }

    // /** WHERE :fieldName IN (:fieldValue1, :fieldValue2, ...) **/
    // private DbWhere onIn(String fieldName, Object... fieldValues) {
    //     this.put("In", fieldName, fieldValues);
    //     return this;
    // }

    /** WHERE :fieldName IN (:fieldValue1, :fieldValue2, ...) **/
    private DbWhere onIn(String fieldName, List<?> fieldValues) {
        this.put("In", fieldName, fieldValues);
        return this;
    }

    // /** WHERE :fieldName BETWEEN :minValue AND :maxValue **/
    // private DbWhere onBetween(String fieldName, Object... fieldValues) {
    //     this.put("Between", fieldName, fieldValues);
    //     return this;
    // }

    /** WHERE :fieldName BETWEEN :minValue AND :maxValue **/
    private DbWhere onBetween(String fieldName, List<Object> fieldValues) {
        this.put("Between", fieldName, fieldValues);
        return this;
    }

    // /** WHERE :fieldName BETWEEN :minValue AND :maxValue **/
    // private DbWhere onBetween(String fieldName, Object minValue, Object maxValue) {
    //     this.put("Between", fieldName, new Object[] { minValue, maxValue });
    //     return this;
    // }
    //
    // /** WHERE :fieldName BETWEEN :minValue AND :maxValue **/
    // private DbWhere onBetween(String fieldName, Date minValue, Date maxValue) {
